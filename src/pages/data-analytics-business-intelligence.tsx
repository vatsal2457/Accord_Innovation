...
const DataAnalyticsBusinessIntelligence: React.FC = () => {
  return (
    <div>
      <Hero
        title="Data Analytics &"
        subtitle="Business Intelligence"
        description="Transform your business with data-driven insights and analytics solutions that enable informed decision-making and drive growth."
      ...
      {/* Data Analytics & Business Intelligence Content */}
      ...
      {/* Data Analytics & Business Intelligence OFFERINGS */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-[#0a3d62]">Data Analytics & Business Intelligence</span>{" "}
              <span className="text-[#f47847]">OFFERINGS</span>
            </h2>
            <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive analytics solutions designed to transform your data into actionable insights and drive informed decision-making
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Data Integration</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                We help you integrate data from multiple sources into a unified analytics platform. Our solutions ensure data quality, consistency, and accessibility for comprehensive analysis.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Data Visualization</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Our data visualization solutions transform complex data into intuitive, interactive dashboards and reports. We help you communicate insights effectively and drive data-driven decision-making.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Predictive Analytics</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                We implement predictive analytics solutions that forecast trends and identify opportunities. Our advanced analytics models help you anticipate market changes and make proactive decisions.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Business Intelligence</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Our business intelligence solutions provide comprehensive insights into your operations, customers, and market. We help you transform data into strategic knowledge that drives business growth.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
          </div>
