...
const Sustainability: React.FC = () => {
  ...
  const renderToggleButton = (card: string) => (
    ...
    >
      <span className="text-2xl font-light text-white transition-transform duration-300"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative">
            <div className="relative h-80 rounded-xl overflow-hidden group mb-4">
              ...
              <div className="relative h-full flex flex-col items-center justify-center p-6">
                <h3 className="text-2xl font-bold text-white text-center mb-6">Ethical Responsibility</h3>
          ...
          <div className="relative">
            <div className="relative h-80 rounded-xl overflow-hidden group mb-4">
              ...
              <div className="relative h-full flex flex-col items-center justify-center p-6">
                <h3 className="text-2xl font-bold text-white text-center mb-6">Responsible Operations</h3>
          ...
          <div className="relative">
            <div className="relative h-80 rounded-xl overflow-hidden group mb-4">
              ...
              <div className="relative h-full flex flex-col items-center justify-center p-6">
                <h3 className="text-2xl font-bold text-white text-center mb-6">Ethical Partnership</h3>
          ...
          <div className="relative">
            <div className="relative h-80 rounded-xl overflow-hidden group mb-4">
              ...
              <div className="relative h-full flex flex-col items-center justify-center p-6">
                <h3 className="text-2xl font-bold text-white text-center mb-6">Community Engagement</h3>
          ...
          <div className="relative">
            <div className="relative h-80 rounded-xl overflow-hidden group mb-4">
              ...
              <div className="relative h-full flex flex-col items-center justify-center p-6">
                <h3 className="text-2xl font-bold text-white text-center mb-6">Employee Well-being</h3>
          ...
          <div className="relative">
            <div className="relative h-80 rounded-xl overflow-hidden group mb-4">
              ...
              <div className="relative h-full flex flex-col items-center justify-center p-6">
                <h3 className="text-2xl font-bold text-white text-center mb-6">Continuous Progress</h3>
