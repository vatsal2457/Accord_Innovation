        ...
        <div className="space-y-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/krishna.png"
            ...
            <div className="w-full md:w-2/3 space-y-4">
              ...
              <p className="text-gray-600">Lorem ipsum dolor sit amet, fastidii platonem ei vis, nam at omnis vivendo necessitatibus.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/suchitra.png"
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/swathi.png"
                alt="Swathi Mula"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/alisha.png"
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/rohith.png"
                alt="Rohith Krupal"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/ambika.png"
                alt="Ambika Ayeappan"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/kumar.png"
                alt="Kumar Nityanand"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/abhishek.png"
                alt="Abhishek Gupta"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/deepika.png"
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/rupal.png"
                alt="Rupal Pandey"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/kirti.png"
                alt="Kirti Sharma"
                className="w-full h-[400px] object-cover object-center rounded-lg shadow-lg"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="w-full md:w-1/3">
              <img 
                src="/images/Accord Innovations_files/santhosh.png"
