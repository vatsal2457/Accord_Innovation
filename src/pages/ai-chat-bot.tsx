  ...
  return (
    <div className="min-h-screen bg-white">
      <Hero
        title="AI &"
        subtitle="Chatbot"
        description="Enhance customer engagement with intelligent AI and chatbot solutions that provide 24/7 support, streamline operations, and deliver personalized experiences."
      ...
      {/* AI & Chatbot OFFERINGS */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-[#0a3d62]">AI & Chatbot</span>{" "}
              <span className="text-[#f47847]">OFFERINGS</span>
            </h2>
            <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive AI and chatbot solutions designed to enhance your customer engagement, streamline operations, and deliver personalized experiences
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Chatbot Development</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                We develop tailored chatbot solutions that address your specific business challenges. Our chatbot development services cover everything from simple FAQ bots to complex conversational AI systems.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">AI Integration</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Our AI integration services ensure seamless connectivity between your systems and AI technologies. We specialize in natural language processing, machine learning, and other AI solutions that deliver optimal performance.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                We implement comprehensive optimization measures to enhance your AI and chatbot performance. Our optimization solutions include response time improvements, accuracy enhancements, and user experience refinements.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Security & Compliance</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                We ensure your AI and chatbot solutions adhere to the highest security and compliance standards. Our security measures include data encryption, access control, and compliance monitoring to protect your systems and user data.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
          </div>
