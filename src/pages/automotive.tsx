  ...
  return (
    <div className="min-h-screen bg-white">
      <Hero
        ...
        backgroundImage="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-20">
      <div className="order-2 md:order-1 self-center">
        ...
        <div className="space-y-6 text-justify max-w-prose text-gray-700">
          <p className="text-base md:text-lg leading-relaxed">
            In the automotive industry, IT solutions are essential for driving innovation, enhancing safety, and improving the overall driving experience. From connected vehicles to autonomous driving technologies, digital transformation is reshaping how vehicles are designed, manufactured, and operated.
          </p>
          <p className="text-base md:text-lg leading-relaxed">
            Advanced technologies like artificial intelligence, IoT, and cloud computing enable automotive companies to optimize production processes, implement predictive maintenance, and develop innovative features that enhance vehicle performance and safety. This digital evolution is crucial for staying competitive in a rapidly evolving market where consumers expect seamless connectivity and advanced safety features.
          </p>
        </div>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
      <div className="relative order-1 self-center">
        <img 
          src="https://images.unsplash.com/photo-1485291571150-772bcfc10da5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" 
      ...
      <div className="order-2 self-center">
        ...
        <div className="space-y-6 text-justify max-w-prose text-gray-700">
          <p className="text-base md:text-lg leading-relaxed">
            Accord Innovations provides comprehensive IT solutions tailored to the automotive industry. Our expertise in manufacturing automation, connected vehicle technologies, and safety systems helps organizations optimize their operations and enhance vehicle performance.
          </p>
          <p className="text-base md:text-lg leading-relaxed">
            We leverage advanced technologies such as IoT, AI, and cloud computing to enable smart manufacturing, predictive maintenance, and enhanced vehicle connectivity. With Accord Innovations as your technology partner, you can stay ahead of industry trends and deliver exceptional automotive experiences.
          </p>
        </div>
      </div>
    </div>
